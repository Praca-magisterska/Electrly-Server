...
exports.deleteThreadReaction = exports.updateThreadReaction = exports.findThreadReactions = exports.findThreadReaction = exports.createThreadReaction = void 0;
...
exports.createThreadReaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadReaction.create({
...
exports.findThreadReaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadReaction.findUnique({
                        where: {
                            id: req.params.id
                        }
                    })];
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("ThreadReaction not found");
                }
...
exports.findThreadReactions = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadReaction.findMany()];
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("ThreadReaction not found");
...
exports.updateThreadReaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadReaction, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                threadReaction = _a.sent();
                if (!threadReaction) {
                    throw new HTTPError_1.NotFoundError("ThreadReaction not found");
                }
                return [4 /*yield*/, prisma.threadReaction.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteThreadReaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadReaction, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.threadReaction["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];

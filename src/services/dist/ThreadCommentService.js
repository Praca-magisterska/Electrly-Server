...
exports.deleteThreadComment = exports.updateThreadComment = exports.findThreadComments = exports.findThreadComment = exports.createThreadComment = void 0;
...
exports.createThreadComment = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadComment.create({
...
exports.findThreadComment = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadComment.findUnique({
                        where: {
                            id: req.params.id
                        }
                    })];
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("ThreadComment not found");
                }
...
exports.findThreadComments = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadComment.findMany()];
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("ThreadComment not found");
...
exports.updateThreadComment = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadComment, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                threadComment = _a.sent();
                if (!threadComment) {
                    throw new HTTPError_1.NotFoundError("ThreadComment not found");
                }
                return [4 /*yield*/, prisma.threadComment.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteThreadComment = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadComment, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.threadComment["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];

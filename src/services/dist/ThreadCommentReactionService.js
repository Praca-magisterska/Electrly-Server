...
exports.deleteThreadCommentReaction = exports.updateThreadCommentReaction = exports.findThreadCommentReactions = exports.findThreadCommentReaction = exports.createThreadCommentReaction = void 0;
...
exports.createThreadCommentReaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadCommentReaction.create({
...
exports.findThreadCommentReaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var record, responseBodyResult, responseBody, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadCommentReaction.findUnique({
                        where: {
                            id: req.params.id
                        }
                    })];
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("ThreadCommentReaction not found");
                }
...
exports.findThreadCommentReactions = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadCommentReaction.findMany()];
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("ThreadCommentReaction not found");
...
exports.updateThreadCommentReaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadCommentReaction, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                threadCommentReaction = _a.sent();
                if (!threadCommentReaction) {
                    throw new HTTPError_1.NotFoundError("ThreadCommentReaction not found");
                }
                return [4 /*yield*/, prisma.threadCommentReaction.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteThreadCommentReaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadCommentReaction, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.threadCommentReaction["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];

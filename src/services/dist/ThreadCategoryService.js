...
exports.deleteThreadCategory = exports.updateThreadCategory = exports.findThreadCategories = exports.findThreadCategory = exports.createThreadCategory = void 0;
...
exports.createThreadCategory = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadCategory, record, responseBodyResult, responseBody, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prisma.threadCategory.findUnique({
                        where: {
            ...
            case 1:
                threadCategory = _a.sent();
                if (threadCategory) {
                    throw new HTTPError_1.ConflictError("ThreadCategory already exists");
                }
                return [4 /*yield*/, prisma.threadCategory.create({
...
exports.findThreadCategory = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                record = _a.sent();
                if (!record) {
                    throw new HTTPError_1.NotFoundError("ThreadCategory not found");
                }
...
exports.findThreadCategories = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var records, responseBodyResult, responseBody, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.threadCategory.findMany()];
            case 1:
                records = _a.sent();
                if (records.length === 0) {
                    throw new HTTPError_1.NotFoundError("ThreadCategory not found");
...
exports.updateThreadCategory = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadCategory, record, responseBodyResult, responseBody, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.threadCategory.update({
                        where: {
                            id: req.params.id
                        },
                        data: __assign({}, req.body.data)
...
exports.deleteThreadCategory = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var threadCategory, record, responseBodyResult, responseBody, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.threadCategory["delete"]({
                        where: {
                            id: req.params.id
                        }
                    })];
